...
sudo docker build -f ./dockerfiles/gpu.Dockerfile --build-arg TF_PACKAGE_VERSION=1.11.0 -t registry.cn-hangzhou.aliyuncs.com/geekcloud/tf-gpu-py3:1.11.0 .
sudo docker build -f ./dockerfiles/gpu.Dockerfile -t registry.cn-hangzhou.aliyuncs.com/geekcloud/tf-gpu-py3:latest .
sudo docker build -f ./dockerfiles/cpu.Dockerfile -t registry.cn-hangzhou.aliyuncs.com/geekcloud/tf-cpu-py3:latest .
...
sudo docker push registry.cn-hangzhou.aliyuncs.com/geekcloud/tf-gpu-py3:1.11.0
sudo docker push registry.cn-hangzhou.aliyuncs.com/geekcloud/tf-cpu-py3:latest
sudo docker push registry.cn-hangzhou.aliyuncs.com/geekcloud/tf-cpu-py3:1.11.0
sudo docker logout
